...
int main(int argc, char *argv[])
{
   ...
   RectSliceCoefficient RectVoltsSlice(0.8, 0.1);
   ...
   //Show parts of the mesh
   ParGridFunction AttrGF(&fespace);
   RegionShowCoeff ShowReg;
   AttrGF.ProjectCoefficient(ShowReg);
